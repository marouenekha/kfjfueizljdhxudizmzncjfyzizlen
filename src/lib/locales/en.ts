export default {
  ...
  whatsappHint: "Include country code (e.g. +213). Used so others can chat with you on WhatsApp.",
  addWhatsappPrompt: "Add your WhatsApp number so buyers can contact you.",
  addWhatsappCta: "Add now",
  provider: "Provider",
  joined: "Joined",
  followers: "Followers",
  ...
  cartEmptyDesc: "Browse stores and add your favorite items.",
  subtotal: "Subtotal",
  total: "Total",
  ...
  cashOnDeliveryDesc: "Pay in cash when your order is delivered",
  placeOrder: "Place order",
  orderPlaced: "Order placed!",
  orderPlacedDesc: "The seller will receive your order shortly.",
