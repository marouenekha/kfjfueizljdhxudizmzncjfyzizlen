export default {
  ...
  whatsappHint: "Inclure l'indicatif du pays (ex. +213). Utilisé pour que les autres vous contactent sur WhatsApp.",
  addWhatsappPrompt: "Ajoutez votre numéro WhatsApp pour que les acheteurs puissent vous contacter.",
  addWhatsappCta: "Ajouter",
  ...
  // Creation screen
  create: "Créer",
  storeProduct: "Produit",
  createPortfolioItem: "Nouveau projet portfolio",
  createStoreProduct: "Nouveau produit boutique",
  projectImages: "Images du projet",
  projectVideo: "Vidéo du projet",
  addVideoOptional: "Ajouter une vidéo (optionnel)",
  projectTitleLabel: "Titre du projet",
  projectTitlePlaceholder: "ex. Rénovation cuisine...",
  portfolioDescPlaceholder: "Décrivez votre projet ou travail réalisé...",
  tagsOptional: "Tags (optionnel)",
  tagsPlaceholder: "ex. design, rénovation, branding",
  ...
  reposted: "Partagé sur votre profil !",
  repostedDesc: "Ce post apparaît maintenant sur votre profil",
  repostedBy: "Repartagé par",
  failedToRepost: "Échec du partage",
  shareNow: "Partager maintenant",
  shareWithText: "Écrire quelque chose et partager",
  sharedAPost: "a partagé une publication",
  sayAboutThis: "Dites quelque chose à propos de ça...",
  you: "Vous",
  addTextToShare: "Ajoutez du texte pour partager",
  ...
  cartEmptyDesc: "Parcourez les boutiques et ajoutez vos articles préférés.",
  subtotal: "Sous-total",
  total: "Total",
  ...
  orderPlacedDesc: "Le vendeur recevra votre commande très bientôt.",
